...
VALUES
	...
	INSERT INTO [dbo].[PurchaseOrders] ([SupplierID], [OrderDate], [TotalAmount])
VALUES
    (1, '2023-01-01', 100.00),
    (2, '2023-02-01', 20.00),
    (3, '2023-03-01', 250.00),
	...
	INSERT INTO [dbo].[OrderDetails] ([EmployeeName], [DateCreated], [Total])
VALUES
    ('Employee1', '2023-01-01', 87.00),
    ('Employee2', '2023-02-01', 19.99),
    ('Employee3', '2023-03-01', 46.00),
    ('Employee4', '2023-04-01', 67.00),
    ('Employee5', '2023-05-01', 90.00),
    ('Employee6', '2023-06-01', 136.00),
    ('Employee7', '2023-07-01', 127.00),
    ('Employee8', '2023-08-01', 200.00),
    ('Employee9', '2023-09-01', 150.00),
    ('Employee10', '2023-10-01', 189.00),
    ('Employee11', '2023-11-01', 69.00),
    ('Employee12', '2023-12-01', 140.00),
    ('Employee13', '2024-01-01', 50.00),
    ('Employee14', '2024-02-01', 79.00),
    ('Employee15', '2024-03-01', 25.00),
    ('Employee16', '2024-04-01', 16.00),
    ('Employee17', '2024-05-01', 70.00),
    ('Employee18', '2024-06-01', 10.00),
    ('Employee19', '2024-07-01', 190.00),
    ('Employee20', '2024-08-01', 145.00);